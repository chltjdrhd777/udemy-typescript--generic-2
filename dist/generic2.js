...
const merged2 = merge2({ name: "Anderson", hobbies: ["work out", "flower arrangement"] }, { age: 30 });
...
function merge3(object, object2) {
...
const mergedObj = merge3({ Name: "James", Major: { core: "ecology" } }, { hobbies: "biking" });
